...
class TurnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turno" do
    assert_difference("Turno.count") do
      post turnos_url, params: { turno: { comentario: @turno.comentario, estado: @turno.estado, fecha_hora: @turno.fecha_hora, motivo: @turno.motivo } }
    end
  ...
  test "should update turno" do
    patch turno_url(@turno), params: { turno: { comentario: @turno.comentario, estado: @turno.estado, fecha_hora: @turno.fecha_hora, motivo: @turno.motivo } }
